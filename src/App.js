        ...
        <div className="content">
          ...
          <div className="submitButton" onClick={this.savePassword}>
            <span className="submitButtonText">
              {editing ? 'به روز رسانی' : 'اضافه کردن'}
            </span>
          </div>
        </div>
      </div>
